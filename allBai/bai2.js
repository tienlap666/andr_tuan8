...
export default function App() {
  ...
  const [locationMouse, setLocationMouse] 
      = useState({
        x: null,
        y: null,
        marginLeftM1: new Animated.Value(rXM1),
        marginTopM1: new Animated.Value(rYM1)
  ...
  const [locationMouse2, setLocationMouse2] 
      = useState({
        x: null,
        y: null,
        marginLeftM2: new Animated.Value(rXM2),
        marginTopM2: new Animated.Value(rYM2)
    ...
    const [locationMouse3, setLocationMouse3] 
      = useState({
        x: null,
        y: null,
        marginLeftM3: new Animated.Value(rXM3),
        marginTopM3: new Animated.Value(rYM3)
